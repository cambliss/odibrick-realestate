...
# Odibrick Backend Quick Setup Script
# This script helps you set up the Odibrick backend quickly
...
# Header
print_header "🏠 Odibrick Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/odibrick
