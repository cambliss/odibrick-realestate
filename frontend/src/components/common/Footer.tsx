        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Odibrick" loading="lazy" decoding="async" width="40" height="40" className="h-10 w-auto" />
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-10 h-10 bg-[rgba(255,255,255,0.05)] hover:bg-[#004AAD] border border-[rgba(255,255,255,0.1)] rounded-lg flex items-center justify-center transition-all group"
              >
            ...
            <ul className="space-y-4">
              <li>
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-[color] group">
                  <MapPin className="w-5 h-5 mt-0.5 flex-shrink-0 text-[#004AAD]" />
              ...
              <li>
                <a href="tel:04024595107" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-[color]">
                  <Phone className="w-5 h-5 flex-shrink-0 text-[#004AAD]" />
                  <span>040 2459 5107</span>
                </a>
              </li>
              <li>
                <a href="mailto:hello@odibrick.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-[color]">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#004AAD]" />
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <input
                ...
                className="w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 font-manrope font-extralight text-sm text-white placeholder:text-[#6b7280] focus:outline-none focus:border-[#004AAD] transition-[border-color]"
                required
              />
              <button
                type="submit"
                className="w-full bg-[#004AAD] hover:bg-[#003B8B] text-white font-manrope font-bold text-sm px-4 py-3 rounded-lg transition-all shadow-lg hover:shadow-xl"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 Odibrick. All rights reserved. Powered by AI.
            </p>
