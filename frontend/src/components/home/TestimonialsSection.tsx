    ...
    <section className="bg-[#F9F7F2] py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="flex justify-between items-center mb-16">
          <div>
            <div className="font-space-mono text-sm text-[#004AAD] uppercase tracking-widest mb-4">Testimonials</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-[#f3f4f6] rounded-2xl p-8">
            ...
            <p className="font-manrope text-base text-[#4b5563] leading-relaxed mb-6">
              "Odibrick's AI matched us with our dream home in just 2 weeks. The process was seamless and personalized."
            </p>
